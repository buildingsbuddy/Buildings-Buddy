...
icon: FileDown,
title: 'Export to PDF',
desc: 'Print or save calculation results as a clean PDF — share with clients, suppliers or your team.',
},
{
icon: FolderOpen,
...
desc: 'Company plan includes up to 5 team members on one account.',
},
{
icon: Shield,
title: 'UK Building Standards',
desc: 'Calculations are built around UK construction methods, material usage and estimating guidance.',
},
];
...
monthly: '£19.99',
yearly: '£199',
desc: 'All calculators, guide material pricing, PDF export and up to 20 saved projects.',
},
{
name: 'Company Plan',
monthly: '£49',
yearly: '£490',
desc: 'Everything in DIY plus unlimited projects, team access and professional workflow.',
},
];
...
The go-to platform for tradespeople, DIY users, handymen and small
companies to estimate construction materials, guide costs and save
...
<Button size="lg" variant="ghost" onClick={handleLogin}>
Login
</Button>
</div>
</motion.div>
...
Start with a 7-day free trial. Material guide pricing included. Labour,
VAT, delivery and overheads are not included.
</p>
