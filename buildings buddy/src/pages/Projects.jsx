...
export default function Projects() {
  ...
  const [newProject, setNewProject] = useState({ name: '', calculator_type: 'wall_construction', notes: '' });
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setDialogOpen(false);
      setNewProject({ name: '', calculator_type: 'wall_construction', notes: '' });
    },
  });
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={v => setNewProject(p => ({ ...p, calculator_type: v }))}
                >
              ...
              <CardContent className="p-4 flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <Badge variant="secondary" className="capitalize text-xs shrink-0">{p.status}</Badge>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-muted-foreground">
                    <span className="capitalize">{p.calculator_type?.replace(/_/g, ' ')}</span>
                    {p.created_date && (
