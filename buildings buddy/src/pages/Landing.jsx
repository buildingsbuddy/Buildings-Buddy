    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 w-full bg-background/80 backdrop-blur-md border-b border-border z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Button onClick={() => base44.auth.redirectToLogin()} className="bg-accent text-accent-foreground hover:bg-accent/90 font-semibold">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" onClick={() => base44.auth.redirectToLogin()} className="bg-accent text-accent-foreground hover:bg-accent/90 font-semibold text-base px-8">
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button size="lg" onClick={() => base44.auth.redirectToLogin()} className="mt-10 bg-accent text-accent-foreground hover:bg-accent/90 font-semibold text-base px-8">
            Start Free Trial <ArrowRight className="w-5 h-5 ml-2" />
          </Button>
        </div>
      </section>
